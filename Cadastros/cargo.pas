       ...
       Begin
         buscCarg := DataModule1.QueryCargo['nome'];
          ...
          //limparcamposCargo;
            ...
            Begin
             MessageDlg('O cargo: ' + edtNome.Text + ' Já existe no Banco de Dados!!' , mtInformation, [mbOK], 0);
             exit;
             End;
        DataModule1.tb_cargo.Edit;
...
begin
 if Trim(edtNome.Text) <> '' then
  Begin
    ...
    if not DataModule1.QueryCargo.IsEmpty then
    Begin
     MessageDlg('Cargo ** ' + edtNome.Text + ' ** já existe no Banco de Dados!', mtWarning, [mbOK], 0);
     edtNome.SetFocus;
     exit;
    End;
